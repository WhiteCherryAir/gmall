package com.bai.gmall.search.controller;
...
import com.bai.gmall.service.SearchService;
...
public class SearchController {
    ...
    @Reference
    AttrInfoSearchService attrInfoSearchService;
    ...
    public String list(PmsSearchParam pmsSearchParam, ModelMap modelMap) {//三级分类id、关键字、
        ...
        //根据valueId将属性列表查询出来
        List<PmsBaseAttrInfo> pmsBaseAttrInfos = attrInfoSearchService.getAttrValueListByValueId(valueIdSet);
        ...
        if (delValueIds != null) {
            ...
            //如果valueIds不为空，说明当前请求中包含属性的参数，每一个属性参数，都会生成一个面包屑
